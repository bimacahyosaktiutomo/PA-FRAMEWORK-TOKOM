...
function toggleSideBar(): void {
    ...
    const sidebar_off_canvas = document.getElementById('sidebar-off-canvas') as HTMLElement;
    const hamburger_button_container = document.getElementById('hamburger-button-container') as HTMLElement;
    const hidden_hamburger_button = document.getElementById('hidden-hamburger-button') as HTMLElement;
...
const sidebarItems = document.querySelectorAll<HTMLLIElement>('#sidebar li, #sidebar-off-canvas li');
